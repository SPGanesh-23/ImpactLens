      ...
      <main className="arcade-grid flex flex-1 flex-col items-center justify-center px-4 py-16">
        <div className="card w-full max-w-md text-center">
          <span className="mx-auto mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-olive shadow-[0_6px_16px_rgba(115,126,27,0.3)]">
            <svg viewBox="0 0 24 24" fill="none" className="h-7 w-7 text-paper" aria-hidden="true">
              <path d="M12 21c5-2 8-6 8-11V5l-8-2-8 2v5c0 5 3 9 8 11z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
              <path d="M12 8c-2 1.5-3 3.5-3 6M12 8c2 1.5 3 3.5 3 6" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
            </svg>
          </span>
          <h1 className="font-display mb-2 text-2xl font-semibold text-charcoal">
            Welcome back
          </h1>
          <p className="mb-6 text-sm text-warm">
            Sign in to track quests and unlock badges.
          </p>
          ...
          <form onSubmit={handleCredentialsSubmit} className="flex flex-col gap-4 text-left">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-warm/30 bg-white/50 px-4 py-2 focus:border-olive focus:outline-none focus:ring-2 focus:ring-olive/20"
          ...
          <div className="my-6 flex items-center justify-center">
            <div className="h-px w-full bg-warm/20"></div>
            <span className="px-4 text-xs text-warm">OR</span>
            <div className="h-px w-full bg-warm/20"></div>
          </div>
